...
```console
curl https://api.bybit.com/contract/v3/public/orderBook/L2?symbol=BTCUSD
```
...
GET
<code><span id=vpoL2>/contract/v3/public/orderBook/L2</span></code>
...
```console
curl https://api.bybit.com/contract/v3/public/kline/list?symbol=BTCUSD&interval=1&limit=2&from=1581231260
```
...
<p class="fake_header">t(:httprequest)</p>
GET
<code><span id=vpkList>/contract/v3/public/kline/list</span></code>
...
```console
curl https://api.bybit.com/contract/v3/public/tickers
```
...
<p class="fake_header">t(:httprequest)</p>
GET
<code><span id=vpTickers>/contract/v3/public/tickers</span></code>
...
```console
curl https://api.bybit.com/contract/v3/public/trading-records?symbol=BTCUSD
```
...
<p class="fake_header">t(:httprequest)</p>
GET
<code><span id=vpTradingRecords>/contract/v3/public/trading-records</span></code>
...
<p class="fake_header">t(:httprequest)</p>
GET
<code><span id=vpSymbols>/contract/v3/public/symbols</span></code>
...
```console
curl https://api.bybit.com/contract/v3/public/liq-records?symbol=BTCUSD
```
...
<p class="fake_header">t(:httprequest)</p>
GET
<code><span id=vpkLiq>/contract/v3/public/liq-records</span></code>
...
```console
curl "https://api.bybit.com/contract/v3/public/mark-price-kline?symbol=BTCUSD&interval=1&limit=2&from=1581231260"
```
...
<p class="fake_header">t(:httprequest)</p>
GET
<code><span id=plmpk>/contract/v3/public/mark-price-kline</span></code>
...
```console
curl "https://api.bybit.com/contract/v3/public/index-price-kline?symbol=BTCUSD&interval=1&limit=2&from=1581231260"
```
...
<p class="fake_header">t(:httprequest)</p>
GET
<code><span id=v2pIndexPriceKline>/contract/v3/public/index-price-kline</span></code>
...
```console
curl "https://api.bybit.com/contract/v3/public/premium-index-kline?symbol=BTCUSD&interval=1&limit=2&from=1581231260"
```
...
<p class="fake_header">t(:httprequest)</p>
GET
<code><span id=vpPremiumIndexKline>/contract/v3/public/premium-index-kline</span></code>
...
```console
curl https://api.bybit.com/contract/v3/public/open-interest?symbol=BTCUSD&period=5min
```
...
<p class="fake_header">t(:httprequest)</p>
GET
<code><span id=vpMarketOpenInterest>/contract/v3/public/open-interest</span></code>
...
```console
curl https://api.bybit.com/contract/v3/public/big-deal?symbol=BTCUSD
```
...
<p class="fake_header">t(:httprequest)</p>
GET
<code><span id=vpMarketBigDeal>/contract/v3/public/big-deal</span></code>
...
```console
curl https://api.bybit.com/contract/v3/public/account-ratio?symbol=BTCUSD&period=5min
```
...
<p class="fake_header">t(:httprequest)</p>
GET
<code><span id=vpMarketAccountRatio>/contract/v3/public/account-ratio</span></code>
